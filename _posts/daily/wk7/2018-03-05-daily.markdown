...
{% assign verse1 = bibleTitle1 %}
{% assign bgV1 = bibleGatewayRef1 %}
{% assign yvV1 = youVersionRef1 %}
{% assign verse2 = bibleTitle2 %}
{% assign bgV2 = bibleGatewayRef2 %}
{% assign yvV2 = youVersionRef2 %}
