...
|[《上週{{ lastWeek }}]({{ lastLink }})|[主页](/)|[下週{{ nextWeek }}》]({{ nextLink }})|
|-----------|
...
{% assign thisWeek = site.posts | <div id="top"></div>

{% assign lastWeek = page.week | minus:"1" %}
{% assign nextWeek = page.week | plus:"1" %}
{% assign lastLink = "wk" | append:lastWeek | append:".html" %}
{% assign lastLink = "wk" | append:nextWeek | append:".html" %}
{% assign filter = "/guide/wk" | append:page.week | append:".html" %}
...
{% assign thisWeek = site.posts | where: {{ filter }} | sort: "date" %}
